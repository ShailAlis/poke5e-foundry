...
import { POKEMON_FEATS, POKEMON_STANDARD_FEAT_NAMES, pokemonFeatSources } from "../trainer/feat-catalog.mjs";
...
const { pokemonFeatOptions, trainerFeatOptions } = await import("../trainer/feat-catalog.mjs");
